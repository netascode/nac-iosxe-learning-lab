...
<figure markdown>
  ![VS Code ACL Configuration](./assets/vscode-acl.png){ width="500" }
</figure>
...
<figure markdown>
  ![Terraform ACL Apply](./assets/terraform-acl-apply.png){ width="500" }
</figure>
...
<figure markdown>
  ![Show Access List](./assets/sh-access-list.png){ width="500" }
</figure>
